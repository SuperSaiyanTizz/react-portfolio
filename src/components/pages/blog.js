...
class Blog extends Component {
  ...
  onScroll() {
   if (
        ...
        this.state.blogItems.lenght === this.state.totalCount
        ) {
  ...
  getBlogItems() {
    axios
      .get(`https://philiip.devcamp.space/portfolio/portfolio_blogs?page=${this
      .state.currentPage}`, 
      {
  ...
  render() {
    ...
    return (
      ...
      />
       ...
       {this.props.loggedInStatus === "Logged In" ? (
